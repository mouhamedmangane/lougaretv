<template>
      <div class="w-full flex ">
        ...
        <!-- property -->
        <div class=" flex justify-center mx-8 bg-neutral-100  max-h-[88vh] h-[88vh] 2xl:max-h-[90vh] 2xl:h-[90vh] overflow-y-auto m-4 grow">
            <!-- elements -->
            <div class="border  p-4 w-[900px] w-max-[900px] ">
                <div class="bg-white p-4" v-if="titre || (elements && elements.length)" >
...
export default {
  ...
  data(){
      let courant=(this.elements.length>0)?this.elements[this.elements.length-1].position+1:0;
      return {
          propertyActive:[],
          courant:courant,
          dragSrcEl:-1,
  ...
  methods:{
    ...
    deleteElement(element){
      ...
      drop(e,position){
        ...
        if(position!=this.dragSrcEl && this.dragSrcEl!=0){
