  ...
  components: { ChoixCouleur, SimpleButton, MessageInput, InputImage },
    ...
    methods:{
        ...
        onSubmit(event){
            ...
            console.log(_.cloneDeep(this.redacteur));
            for(let key in _.cloneDeep(this.redacteur)){
            ...
            if(this.mode=="create"){
                ...
                axios.put('/lougare_npl/redacteur/'+this.redacteur.id,formdata,{headers: {"Content-Type": "multipart/form-data",},})
                .then(res=>{
                    this.onSuccess(res.data);
