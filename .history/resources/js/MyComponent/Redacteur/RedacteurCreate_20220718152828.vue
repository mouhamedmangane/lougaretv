<template>
    ...
    <form action="" class=" p-4 grid grid-cols-2 gap-4" @submit="onSubmit" method="post" ref="myForm">
        ...
        <div class="col-start-2">
            <input type="text" v-model="redacteur.name"  :class="{'':true,'border-red-600':messages.name}" @keyup="message.name=false">
        ...
        <div class="col-start-2">
            <input type="text" v-model="redacteur.email" :class="{'':true,'border-red-600':messages.email}" @keyup="message.email=false">
        ...
        <div class="col-start-2">
            <input type="text" v-model="redacteur.pwd" :class="{'':true,'border-red-600':messages.pwd}" @keyup="message.pwd=false">
