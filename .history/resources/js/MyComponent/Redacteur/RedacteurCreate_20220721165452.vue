<template>
    ...
    <form action="" class=" p-4 grid grid-cols-2 gap-4" @submit="onSubmit" method="post" ref="myForm">
        ...
        <div class="col-start-2">
            <div class="flex items-center">
                <input-image v-model="redacteur.photo" :pathImage="'storage/images/redacteur/'+redacteur.image"
  ...
  components: { ChoixCouleur, SimpleButton, MessageInput, InputImage },
    ...
    methods:{
        ...
        onSubmit(event){
            ...
            let redacteur=(this.mode=='edit')?_.cloneDeep(this.redacteur):this.redacteur;
