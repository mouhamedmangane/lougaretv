<template>
    ...
    <form action="" class=" p-4 grid grid-cols-2 gap-4" @submit="onSubmit" method="post" ref="myForm">
        ...
        <div class="col-start-2">
            <input type="text" v-model="redacteur.pwd" :class="{'col-start-2':true,'border-red-600':messages.pwd}">
        ...
        <div class="col-start-2">
            <input type="text" v-model="redacteur.pwd_confirmation" :class="{'col-start-2':true,'border-red-600':messages.pwd}">
        </div>
