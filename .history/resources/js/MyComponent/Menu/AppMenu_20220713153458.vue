<template>
    <div :class="{'z-20 flex justify-between  items-center relative  py-8  border-b-2 border-red-600 px-8 ':true,}">
        <div class="">
            <div class="relative ">
                <input type="text" class="w-72  pl-4 border-neutral-400 rounded-full">
                 <material-icon nom="search" class="text-2xl ml-2  absolute right-5 bottom-1 text-neutral-300" />
