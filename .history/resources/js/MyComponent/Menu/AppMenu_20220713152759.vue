<template>
    <div :class="{'z-20 flex justify-between  items-center relative  py-8  border-b border-red-600 px-8 ':true,}">
        <div class="">
            <div class="relative ">
                <input type="text" class="w-72  border rounded-full">
            </div>
        </div>
    ...
    <div :class="{ 'w-full  sticky top-0   mt-3  z-20   transition-all  bg-neutral-100  ':true,'text-black bg-white shadow-lg   ':isSmall,'   border-neutral-300':!isSmall}">
