<template>
    <div :class="{'z-20 flex justify-between  items-center relative ':true,}">
        <div class="">

        </div>
        <div class="pt-3 absolute top-2" style="left:503.5px;">
            <a href="/" class="  ">
                    <app-logo  logoClass="h-[193px]"  :inverse="isSmall"/>
            </a>
        </div>
