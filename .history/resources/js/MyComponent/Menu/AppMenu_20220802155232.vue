<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-1 md:py-0  z-30   border-b sm:border-0 transition-all  sm:bg-white  ':true,' md:shadow-lg sh  ':isSmall,' md:shadow-lg   border-neutral-300':!isSmall,' bg-gradient-to-b from-black to-transparent text-white':hasBackground}">
