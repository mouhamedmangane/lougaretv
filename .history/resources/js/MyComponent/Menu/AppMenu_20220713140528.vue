<template>
    <container-box :class="{'z-20 flex justify-between  items-center relative pb-10 ':true,}">
        <div class="">
    ...
    <div :class="{ 'w-full  sticky top-0    z-20   transition-all   ':true,'text-black bg-white shadow-lg   ':isSmall,'   border-b  border-neutral-300':!isSmall}">
        <container-box :class="{'flex justify-center container mx-auto  items-center transition-all relative   border-neutral-300':true}">
