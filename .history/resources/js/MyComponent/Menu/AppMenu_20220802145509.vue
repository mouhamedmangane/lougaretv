<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-2 md:py-0  z-30   transition-all   ':true,'text-black bg-white md:shadow-lg sh  ':isSmall,' text-black bg-white md:shadow-lg   border-neutral-300':!isSmall}">
        <container-box :class="{'relative flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
             <div :class="{'flex items-center   px-4 md:py-1 absolute  left-0  h-[54.5px]':true,'border-neutral-300 top-0':!isSmall,'md:top-0 top-0':isSmall} " style="">
                    <a href="/" class=" ">
