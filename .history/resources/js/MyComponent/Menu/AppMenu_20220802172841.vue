<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-1 md:py-0  z-30    sm:border-0 transition-all  sm:bg-white  ':true,' md:shadow-lg sh  ':isSmall,' md:shadow-lg   border-neutral-300':!isSmall,' sm:bg-gradient-to-b from-black to-transparent text-white bg-white':hasBackground,'border-b':!hasBackground}">
