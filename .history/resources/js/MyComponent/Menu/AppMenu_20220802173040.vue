<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-1 md:py-0  z-30    sm:border-0 transition-all   ':true,' md:shadow-lg sh  ':isSmall,' md:shadow-lg   border-neutral-300':!isSmall,' md:bg-gradient-to-b sm:from-black sm:to-transparent sm:text-white bg-white text-black':hasBackground,'bg-white text-black border-b':!hasBackground}">
