<template>
    <container-box :class="{'z-20 flex justify-between  items-center relative   ':true,}">
        <div class="">

        </div>
        <div class="pt-3 absolute top-1" style="left:503.5px;">
            <a href="/" class="  ">
                    <app-logo  logoClass="h-[70px]"  :inverse="isSmall"/>
            </a>
        </div>
        <div class="flex justify-end items-center pb-10">
    ...
    <div :class="{ 'w-full  sticky top-0   mt-3  z-20   transition-all bg-black text-white   ':true,'text-black bg-white shadow-lg   ':isSmall,'   border-b  border-neutral-300':!isSmall}">
        <container-box :class="{'flex justify-center  items-center transition-all relative   border-neutral-300':true}">
