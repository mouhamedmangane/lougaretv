<template>
    ...
    <div :class="{ 'w-full  sticky top-0    z-20   transition-all   ':true,'text-black bg-white shadow-lg   ':isSmall,'  bg-[#630C0C] border-b text-white  border-neutral-300':!isSmall}">
        <container-box :class="{'flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
             <div :class="{'flex items-center   px-4 py-1 absolute  left-0  h-[54.5px]':true,' top-1    border-neutral-300':!isSmall,'top-0':isSmall} " style="">
                    <a href="/" class=" ">
            ...
            <nav :class=" {'py-2':isSmall,'py-3':!isSmall,'':true}">
                ...
                <ul class="list-none flex font-medium text-[15px]">
