<template>
             ...
             <container-box :class="{'flex justify-between container mx-auto  items-center transition-all   ':true}">
                ...
                <!-- <div class="w-4/12  flex justify-center">
                  ...
                  <div class="flex justify-center items-center w-4/12">
                    <material-icon-text  class="ml-2 mr-4" materialicon='play_circle_filled' text="En direct" iconClass="text-2xl mr-1" textClass="font-medium text-xl"/>
                </div>
    ...
    <div :class="{ 'w-full  sticky top-0  mb-2 z-20   transition-all  mt-2 ':true,'text-black bg-white shadow-lg py-1':isSmall,'text-black py-1 shadow-md  ':!isSmall}">
