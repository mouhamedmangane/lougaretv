<template>
    ...
    <div :class="{ 'w-full  sticky top-0  mb-2 z-20   transition-all   ':true,'text-black bg-white shadow-lg py-1':isSmall,' py-4 ':!isSmall}">
        <container-box :class="{'flex justify-between container mx-auto  items-center transition-all    border-neutral-300':true}">
            ...
            <div class="flex justify-end items-center ">
                    ...
                    <material-icon-text  class="ml-2 mr-4" materialicon='play_circle_filled' text="En direct" iconClass="text-2xl mr-1 bg-red-900 text-white" textClass="font-medium text-xl "/>
