<template>
    ...
    <div :class="{ 'w-full  sticky top-0    z-20   transition-all   ':true,'text-black bg-white shadow-lg   ':isSmall,' text-black bg-white shadow-lg   border-neutral-300':!isSmall}">
        <container-box :class="{'flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
            ...
            <nav :class=" {'py-3':isSmall,'py-3':!isSmall,'py-3 md:absolute':true}">
                <h2 class="text-masquer">Menu</h2>
                <ul class="list-none flex sm:flex-col md:flex-col  font-medium text-[15px]">
                    <menu-item text="A la une" class="border-b border-white"/>
