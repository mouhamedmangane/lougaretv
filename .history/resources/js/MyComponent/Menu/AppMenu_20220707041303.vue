<template>
    ...
    <div :class="{ 'w-full  sticky top-0  relative  z-20   transition-all   border-b':true,'text-black bg-white shadow-lg  ':isSmall,'   border-b':!isSmall}">
        <container-box :class="{'flex justify-between container mx-auto  items-center transition-all    border-neutral-300':true}">
             <div class="flex items-center bg-black px-4 py-3 absolute  top-0 left-0">
                    <a href="/" class=" ">
