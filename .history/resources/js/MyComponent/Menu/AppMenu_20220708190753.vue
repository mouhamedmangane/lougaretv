<template>
    ...
    <div :class="{ 'w-full  sticky top-0    z-20   transition-all   ':true,'text-black bg-white shadow-lg   ':isSmall,'   border-b':!isSmall}">
        <container-box :class="{'flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
             <div :class="{'flex items-center bg-[rgb(250,250,250)]  px-4 py-1 absolute  top-0 left-0 border-x ':true,'pb-2 shadow-inner border-t':!isSmall} ">
                    <a href="/" class=" ">
            ...
            <nav :class=" {'py-2':isSmall,'py-2':true}">
