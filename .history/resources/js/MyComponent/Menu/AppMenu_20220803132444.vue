<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-1 md:py-0  z-30    sm:border-0 transition-all   ':true,' md:shadow-lg sh  ':isSmall,' md:shadow-lg   border-neutral-300':!isSmall,' bg-gradient-to-b from-white to-white text-black sm:bg-none sm:bg-white sm:text-black':hasBackground,'bg-white text-black border-b':!hasBackground}">
        <container-box :class="{'relative flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
             <div :class="{'flex items-center  mx-2 px-2 border sm:border-none bg-black  sm:px-4 md:py-1 absolute  left-0 h-[60px] sm:h-[54.5px]':true,'border-neutral-300 ':!isSmall,'':isSmall} " style="">
                    <a href="/" class=" ">
                        <app-logo  logoClass="md:h-12" :inverse="true" />
                    </a>
            ...
            <nav :class=" {'':isSmall,'':!isSmall,'md:py-3 absolute md:static top-[100%] left-0  w-full md:w-max  overflow-hidden transition-all bg-red-100 md:bg-transparent z-50':true,'h-[100vh - 40px] md:h-max':isDerouler,'h-0 md:h-max':!isDerouler}">
            ...
            <div class="flex justify-end items-center ">
                <!-- <material-icon-text  class="ml-2 mr-4 rounded-full px-4" materialicon='play_circle_filled' text="en direct" iconClass="text-2xl mr-1 text-white" textClass=" hidden sm:inline-block text-xl  text-white"/> -->
                ...
                <button class="ml-2 sm:mr-4 mr-2   rounded-full w-10 h-10  rounded-full  md:hidden " @click="derouler">
