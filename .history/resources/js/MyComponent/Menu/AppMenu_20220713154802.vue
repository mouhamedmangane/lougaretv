<template>
    <div :class="{'z-20 flex justify-between  items-center relative  py-8   px-8 ':true,}">
        <div class="">
            <div class="relative ">
                <input type="text" class="w-72  pl-4 border-neutral-500 rounded-full" placeholder="Rechercher">
        ...
        <div class="flex justify-end items-center ">
                ...
                <button class="ml-2  bg-neutral-100 rounded-full px-6 py-1 ">
                    <!-- <material-icon nom="person" type="outlined" class="text-2xl " /> -->
                    <span class="text-sm">CONNEXION</span>
                </button>
                 <button class="ml-2  bg-[#058DE3]100 rounded-full px-6 py-1 text-white ">
                    <!-- <material-icon nom="person" type="outlined" class="text-2xl " /> -->
    ...
    <div :class="{ 'w-full  sticky top-0     z-20   transition-all    ':true,'text-black bg-white shadow-lg   ':isSmall,' border-b-2 border-red-600  ':!isSmall}">
        <container-box :class="{'flex justify-center  items-center transition-all relative   ':true}">
