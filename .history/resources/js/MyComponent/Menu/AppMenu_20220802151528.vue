<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-1 md:py-0  z-30   border-b sm:border-0 transition-all   ':true,'text-black bg-white md:shadow-lg sh  ':isSmall,' text-black bg-white md:shadow-lg   border-neutral-300':!isSmall}">
