<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-1 md:py-0  z-30    sm:border-0 transition-all   ':true,' md:shadow-lg sh  ':isSmall,' md:shadow-lg   border-neutral-300':!isSmall,' bg-gradient-to-b from-white to-white text-black sm:bg-none sm:bg-white sm:text-black':hasBackground,'bg-white text-black border-b':!hasBackground}">
        <container-box :class="{'relative flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
             <div :class="{'flex items-center  mx-2 px-2 border sm:border-none bg-black  sm:px-4 md:py-1 absolute  left-0 h-[48px] sm:h-[54.5px]':true,'border-neutral-300 ':!isSmall,'':isSmall} " style="">
                    <a href="/" class=" ">
