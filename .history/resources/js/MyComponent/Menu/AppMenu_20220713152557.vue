<template>
    <container-box :class="{'z-20 flex justify-between  items-center relative  py-8  border-b border-red-600 ':true,}">
        <div class="">
            <div class="relative ">
                <input type="text" class="w-72 border-none border rounded-full">
            </div>
        </div>
