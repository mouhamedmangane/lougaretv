<template>
    ...
    <div :class="{ 'w-full  sticky top-0  py-2 md:py-0  z-30   transition-all   ':true,'text-black bg-white md:shadow-lg   ':isSmall,' text-black bg-white md:shadow-lg   border-neutral-300':!isSmall}">
