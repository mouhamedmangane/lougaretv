<template>
    ...
    <div :class="{ 'w-full  sticky top-0    z-20   transition-all   border-b border-neutral-300':true,'text-black bg-white shadow-lg   ':isSmall,'   border-b':!isSmall}">
        <container-box :class="{'flex justify-between container mx-auto  items-center transition-all relative   border-neutral-300':true}">
             <div :class="{'flex items-center  bg-white px-4 py-1 absolute  left-0  h-[54.5px]':true,' top-1  border-x  border-neutral-300':!isSmall,'top-0':isSmall} ">
                    <a href="/" class=" ">
