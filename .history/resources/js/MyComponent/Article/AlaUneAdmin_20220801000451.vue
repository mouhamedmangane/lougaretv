<template>
    <div class="flex flex-wrap justify-center w-full py-4 2xl:pt-0 xl:w-[25rem] mr-4">
        <div class="relative border relative  w-64 2xl:w-1/2 2xl:h-32 col-span-3  bg-white "
             v-for="i in [0,1,2,3]"
