        ...
        onSubmit(event){
            ...
            for(let key in article){
                ...
                if(key!='elements'){
                    ...
                    for(let element of this.article[key]){
                        for(let modelKey in element.mmodel){
                            //formdata.append('elements[]',JSON.parse(JSON.stringify(element)));

                            console.log(modelKey);
                            formdata.append('elements['+element.mmodel.position+']',_JSON.stringify(element));
                            if(element.mmodel.$file)
                                formdata.append('files['+element.mmodel.position+']',_element.mmodel.$file);
