<template>
    ...
    <form action="" class=" p-4 grid grid-cols-2 gap-4" @submit="onSubmit" method="post" ref="myForm">
        ...
        <div class="col-start-2">
            <textarea type="text" v-model="article.titre"  :class="{'2xl:w-80':true,'border-red-600':messages.name}" @keyup="messages.titre=false" row="3"></textarea>
        ...
        <div class="col-start-2">
            <textarea type="text" v-model="article.resume" :class="{'2xl:w-80':true,'border-red-600':messages.email}" @keyup="messages.email=false" row="3"></textarea>
    ...
    <div class="p-4">
        ...
        <div class="">
            <div class="">
                ...
                :class="{'w-[40rem] aspect-[3/1.68] border border-neutral-600':true,'border-red-600':messages.photo}" />
                <div class=" p-4">
