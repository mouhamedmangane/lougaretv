<template>
    <div class="mx-2 bg-white p-4 flex justify-between" >
    ...
    <div class="mt-4 mx-2 bg-white p-4 flex justify-between" >
        <article-create-detail :elements="article.elements" />
    </div>
...
import ArticleCreateDetail from '@/Pages/Admin/Article/ArticleCreateDetail.vue';
import _ from 'lodash';


export default {
  components: { ChoixCouleur, SimpleButton, MessageInput, InputImage, ArticleCreateDetail },
