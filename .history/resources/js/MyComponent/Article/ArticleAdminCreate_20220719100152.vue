<template>
    <div class="mx-2 bg-white p-4 flex justify-between shadow-md" >
        <form action="" class=" p-4 grid  gap-4" @submit="onSubmit" method="post" ref="myForm">
            ...
            <div class="col-start-1"><label for="titre_client"  class="col-start-1" >Titre : </label></div>
            ...
            <div class="col-start-1"><label for="resume_client"  class="col-start-1" >Resume : </label></div>
            <div class="col-start-2">
                <textarea type="text" v-model="article.resume_client" :class="{'2xl:w-80':true,'border-red-600':messages.resume_client}" @keyup="messages.resume=false" rows="3"></textarea>
                <message-input :messageItem="messages.resume_client" :status="status"  />
            </div>

            <div class="col-start-1"><label for="categorie"  class="col-start-1" >Categorie : </label></div>
            <div class="col-start-2">
        ...
        <div class="p-4">
            ...
            <div class="">
                <div class="">
                    <input-image v-model="article.photo" :pathImage="'/images_articles/'+article.id+'/'+article.image"
    ...
    <div class="mt-4 mx-2 bg-white  shadow-md p-4 flex justify-between border " >
        <create-admin-article-detatil :elements="article.elements"  :titre="article.titre"/>
    </div>
