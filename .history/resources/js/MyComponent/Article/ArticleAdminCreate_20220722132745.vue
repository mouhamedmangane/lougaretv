<template>
        ...
        <div class="mr-4">
            ...
            <div class="">
                <div class="">
                    ...
                    :class="{'w-[30rem] 2xl:w-[40rem] aspect-[3/2]  border border-neutral-600':true,'border-red-600':messages.photo}" style="min-height:100px;"/>
    ...
    <div class="mt-8 mx-2 bg-white  shadow-md p-4 flex justify-between border " >
