<template>
    ...
    <form action="" class=" p-4 grid grid-cols-2 gap-4" @submit="onSubmit" method="post" ref="myForm">
        ...
        <div class="col-start-2">
            <input type="text" v-model="article.titre"  :class="{'2xl:w-80':true,'border-red-600':messages.name}" @keyup="messages.titre=false">
        ...
        <div class="col-start-2">
            <textarea type="text" v-model="article.resume" :class="{'2xl:w-80':true,'border-red-600':messages.email}" @keyup="messages.email=false"></textarea>
    ...
    <div>
    <div class="p-4">
        <label class="mb-4 inline-block">Image</label>
        <div class="">
            <div class="">
                <input-image v-model="article.photo" :pathImage="'/images/redacteurs/'+article.image"
                :class="{'w-[40rem] aspect-[3/1.68] border':true,'border-red-600':messages.photo}" />
                <div class=" p-4">
