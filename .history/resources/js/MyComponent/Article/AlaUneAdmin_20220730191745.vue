<template>
    <div class="grid grid-cols-12 gap-4 w-full py-4">
        <div class="relative border relative bg-neutral-100 aspect-[1.5] col-span-3 bg-white"
             v-for="i in [0,1,2,3]"
             ...
             draggable="true"
             >
            <div class="absolute top-0 -left-0 px-8 py-4 rounded-br-3xl border d-flex items-center">
                <span class="text-2xl">{{ i }}</span>
            </div>
            <div v-if="alaunes[i]" class="h-full w-full bg-white">
