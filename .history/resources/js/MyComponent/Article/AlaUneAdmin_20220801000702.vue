<template>
    <div class="flex flex-wrap justify-center w-full py-4 2xl:pt-0 2xl:w-[25rem] mr-4">
        <div class="relative border relative  w-64 2xl:w-1/2  h-56 2xl:h-32 col-span-3  bg-white "
             v-for="i in [0,1,2,3]"
            ...
            <div class="absolute top-0 -left-0 px-6 py-3 rounded-br-3xl border d-flex items-center z-20 bg-primary-700 text-white">
                <span class="md:text-xl text-2xl ">{{ i+1 }}</span>
            </div>
