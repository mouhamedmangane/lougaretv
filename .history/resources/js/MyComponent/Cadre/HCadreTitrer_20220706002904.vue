<template>
    <div class="group  h-full" @click="onClick">
        <my-img :src="pub.image" alt="" :class="{'float-right':inverser,' float-left ':!inverser,'relative shadow inline-block':true} " :size="imageSize" />
        <div :class=" {'relative  h-full inline-block':true,']pr-2':inverser,'pl-2':!inverser}">
