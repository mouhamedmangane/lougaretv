<template>
    <div class="group " @click="onClick">
        ...
        <div :class=" {'order-1 flex flex-col justify-between h-max':true,']pr-2':inverser,'pl-2':!inverser}">
            <titre-3 :size='textSize' class="group-hover:underline h-4/5 grow'">
                <text-limit :text="pub.titre" :maxLength="limitTitre" />
            </titre-3>
            <div class=" text-xs text-neutral-600 pb-1 h-1/5" >societé</div>
