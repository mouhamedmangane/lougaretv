<template>
    <div class="group relative" @click="onClick">
        <my-img :src="pub.image" alt="" :class="{'float-right':inverser,'float-left':!inverser} " :size="imageSize" />
        <div :class=" ['order-1 py-6 grow h-full',espaceText]">
