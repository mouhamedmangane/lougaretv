<template>
    <div class="group  relative h-full" @click="onClick">
        <my-img :src="pub.image" alt="" :class="{'order-2':inverser,'order-1 float-left relative shadow':!inverser} " :size="imageSize" />
        <div :class=" {'order-1 flex flex-col justify-between relative h-full':true,']pr-2':inverser,'pl-2':!inverser}">
            ...
            <div class="px-2 rounded-full text-xs absolute bottom-0 pb-2" >societé</div>
