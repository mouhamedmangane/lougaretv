...
export default {
  components: { AppAdminLayout, AdminContainedBox, Breadcumb, BreadcumbItemFinal, SimpleButton, RedacteurCreate, BreadcumbItem, SearchInput, SimpleLien, MaterialIcon},
  props:['redacteur'],
  data(){
      return {
          search:"",
