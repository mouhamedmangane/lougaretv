    ...
    <app-admin-layout class="bg-neutral-100">
        ...
        <div class="bg-neutral-100 mx-4 px-4 border" >
            <div class="flex justify between border-y w-full py-2 ">
                <div class="flex" >
                    <simple-button icon="save" txt="Enregistrer" class="bg-primary-600 text-sm text-white mx-2"  type="submit" />
                </div>
        ...
        <admin-contained-box class="border mt-4 mx-4 yyy"  >
            <!-- content -->
            <div  class="bg-white" >
                <categorie-create  :categorie="categorie" idForm="form-create-categorie" />
            </div>
            <div >
            </div>
        </admin-contained-box>
...
export default {
  ...
  methods:{
      onClickSave(){
          document.querySelector('#form-create-categorie').submit();
      }
  }
