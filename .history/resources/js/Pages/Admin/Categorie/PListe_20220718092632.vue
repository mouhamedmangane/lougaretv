                            ...
                            <td class="text-center  2xl:w-48 w-32 ">
                                <span class="relative flex justify-center">
                                    ...
                                    <span class="flex hidden group-hover:flex shadow-lg border bg-neutral-200 border-primary-600">
                                        <simple-button class="text-red mr-1 p-1 px-1" icon="delete" @click="deleteCategorie"/>
                                        <simple-lien class="text-red p-1 px-1" icon="edit" :url="'/lougare_npl/categorie/'+this.id+'/edit'"/>
                                    </span>
                                </span>
                            </td>
                        </tr>
