            ...
            <div class="py-4 mt-3 flex justify-between">
                <div class=" ">
                    <breadcumb class="text-2xl">
                        <breadcumb-item txt="" icon="person" url="/lougare_npl/home" class="text-primary-600"/>
                        <breadcumb-item-final txt="Categorie" url="" class="text-primary-600"/>
                    </breadcumb>
                </div>
                <div>
...
export default {
  ...
  methods:{
      ...
      deleteCategorie(id){
          let ok=confirm("Etes vous sûre de vouloir supprimer la categorie : "+id.toUpperCase());
          if(ok){
