      ...
      <admin-contained-box class="">
        ...
        <div class="border bg-neutral-100 p-4 w-[700px] w-max-[700px] ">
            <div class="bg-white p-4" >
                <div v-for="element in elements" :key="element.position" class="p-4 group relative">
                    <div class="flex justify-end hidden group-hover:inline-block absolute bottom-0 rigth-0" >
                        <button @click="deleteElement(element)" class="text-white bg-red-700 text-sm px-3">
                            supprimer
                        </button>
                    </div>
