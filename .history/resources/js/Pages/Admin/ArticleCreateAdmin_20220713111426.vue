<template>
  <app-admin-layout>
      <admin-contained-box class="bg-neutral-100">
        ...
        <!-- formulaire -->
        <div class="flex ">
            <div class="w-1/3 border bg-white shadow">
                <div class="py-2">
                    <input type="text" v-model="titre" placeholder="titre" class="border w-full ">
                </div>
                <div>
                    <textarea name="" row="4">
                    </textarea>
...
export default {
  components: { AppAdminLayout, AdminContainedBox, BreadcumItem, BreadcumbItemFinal, MaterialIcon, SimpleButton },
  props:{
      titre:String,
  }
}
