<template>
    <app-admin-layout class="bg-neutral-100">
        ...
        <admin-contained-box class=" bg-neutral-100  mt-4 mx-2 2xl:flex  text-sm"   >
            <!-- content -->
            <ala-une-admin :alaunes="alaunes" @dropCase="dropCase($event,data)" class="self-start" />
                        ...
                        <tr v-for="(item, index) in liste" :key="item.article_id" class="py-1 even:bg-neutral-200 group"  >
                            ...
                            <td class="p-4"
                                ...
                                @dragend="dragEnd($event,index)"
                                 >
                                <a class="flex items-center hover:underline hover:bg-primary-600" :href="'/lougare_npl/article/'+item.article_id+'/edit'">
