<template>
    <app-admin-layout class="bg-neutral-100">
        ...
        <admin-contained-box class=" bg-neutral-100  mt-4 mx-2 2xl:flex "   >
            <!-- content -->
                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in liste" :key="item.article_id" class="py-1 even:bg-neutral-200 group"  >
                            ...
                            <td class="p-4">
                                <span v-bind="item.txt">
                                    <text-limit :text="item.txt"  maxLength="100" />
                                </span>
                            </td>
                            <td class="p-4">
...
export default {
  components: { AppAdminLayout, AdminContainedBox, Breadcumb, BreadcumbItemFinal, SimpleButton, BreadcumbItem, SearchInput, SimpleLien, MaterialIcon, AlaUneAdmin, TextLimit},
  props:['alaunesInit'],
  data(){
      return {
          search:"",
