            ...
            <div class="flex justify-between border-y w-full py-2 ">
                <div class="flex" >
                    ...
                    <simple-button icon="save" txt="Enregistrer"
                        class="enabled:bg-green-600  disabled:bg-transparent text-sm text-white mx-2"
                        @click="save()"
                        :disabled='hasModifiction'
                        type="submit" />
...
export default {
  ...
  mounted(){
      window.addEventListener('onunload onbeforeunload',this.onQuit);
  }
