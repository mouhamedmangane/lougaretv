<template>
    <app-admin-layout class="bg-neutral-100">
        ...
        <admin-contained-box class=" bg-neutral-100  mt-4 mx-2"  >
            <!-- content -->
            <ala-une-admin :alaunes="alaunes" @dropCase="dropCase(data)" />
            <div  class="bg-white p-4" >
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        <tr v-for="item in liste" :key="item.article_id" class="py-1 even:bg-neutral-200 group"  >
                            <td class="p-4" draggable="true" > A-{{item.article_id}}</td>
                            <td class="p-4">
...
export default {
  components: { AppAdminLayout, AdminContainedBox, Breadcumb, BreadcumbItemFinal, SimpleButton, BreadcumbItem, SearchInput, SimpleLien, MaterialIcon, AlaUneAdmin},
  props:['alaunes'],
  data(){
      return {
          search:"",
