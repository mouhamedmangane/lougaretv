  ...
  <app-admin-layout >
      <admin-contained-box class="">
        ...
        <div class="flex">
            ...
            <simple-button icon="save" txt="Image" class="bg-neutral-600 text-sm text-white mx-2" @change-file="addNewElement('draw_image')" />
...
export default {
  ...
  methods:{
      ...
      valider(){
          axios.post('/lougare_npl/article/store',this.elements)
          .then(res=>{
