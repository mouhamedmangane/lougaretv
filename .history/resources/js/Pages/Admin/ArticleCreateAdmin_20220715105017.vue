      ...
      <admin-contained-box class="">
        ...
        <div class="border bg-neutral-100 p-4">
            <div class="bg-white p-4">
                <component :is="element.nom" v-for="element in elements" :mmodel="element.mmodel"  key="element.index"/>
            </div>
        </div>
...
export default {
  components: { AppAdminLayout, AdminContainedBox, BreadcumItem, BreadcumbItemFinal, MaterialIcon, SimpleButton, InputText, InputGroup, ParagraheDraw },
  props:{
      titre:String,
  },
  data(){
  ...
  methods:{
      addNewElement(index){
          console.log(drawConstantes);
          drawConstantes[index].index=this.courant;
          this.elements.push(Object.assign({},drawConstantes[index]);
          this.courant++;
