      ...
      <admin-contained-box class="">
        ...
        <div class="border bg-neutral-100 p-4">
            <div class="bg-white p-4">
                <component :is="element.nom" v-for="element in elements" v-bind="element.mmodel"  :key="element.position"/>
                <image-draw />
            </div>
        </div>
...
export default {
  ...
  methods:{
      addNewElement(index){
          ...
          for(let key in p.mmodel){
              p.mmodel[key]=reactive(p.mmodel[key]);
          }
          console.log(p);
      ...
      valider(){
          ...
          this.elements[0].mmodel.txt.value='abaa';
      }
  }
}
</script>
