      ...
      <admin-contained-box class="">
        ...
        <div class="border bg-neutral-100 p-4 w-[700px] w-max-[700px] ">
            <div class="bg-white p-4" >
                <div v-for="element in elements" :key="element.position" class="p-4 group relative" draggable="true" @drop="ChangePosition($event,element.position)" :my="element.position">
