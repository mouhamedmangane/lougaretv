      ...
      <admin-contained-box class="">
        ...
        <div class="border bg-neutral-100 p-4 w-[700px] w-max-[700px] ">
            <div class="bg-white p-4" >
                <div v-for="element in elements" :key="element.position" class="p-4">
                    <div class="flex justify-end" >
                        <button @click="deleteElement(element)" class="text-white bg-red-700">
                            supprimer
                        </button>
                    </div>
...
export default {
  ...
  methods:{
      ...
      deleteElement(element){
          for(let i;i<this.elements.length;i++){
              if(this.elements.position==element.position){
