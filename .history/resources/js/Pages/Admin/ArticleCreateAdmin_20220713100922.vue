        ...
        <div class="py-4 flex">
            <div class=" ">
                <breadcumb>
                    ...
                    <breadcumb-item-final txt="Nouveau Article"/>
                </breadcumb>
                <div class="flex">
                    <simple-button icon="save" txt="Enregistrer" class="bg-blue-600 text-white" />
                    <simple-button icon="save" txt="Annuler" class="text-blue-700" />
                </div>
            </div>
            <div>
