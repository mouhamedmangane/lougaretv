...
Route::get('a',function(){
    echo'oooo';
    Artisan::link(public_path('storage'),storage_path('app/public'));
    Artisan::link(public_path('images_articles'),storage_path('app/images_articles'));
    return 'dfjsdmlfjsdmlfjdsfmlsdjf';
